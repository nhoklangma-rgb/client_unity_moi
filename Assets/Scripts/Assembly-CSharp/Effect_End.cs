...
public class Effect_End : MainEffect
{
	...
	public const short END_NAMI_S1_L7 = 180;

	public const short END_ZORO_XOAY_GIO = 181;

	public const short END_LUFFY_S1_L7 = 182;

	public const short END_USSOP_S3_L7 = 183;

	public const short END_NAMI_S2_L7 = 184;

	public const short END_NAMI_S3_L7 = 185;
	...
	public void create_Effect()
	{
		...
		case 0:
			...
			{
				fRemove = 5;
				fraImgEff = new FrameImage(449, 5);
			}
			break;
		case 1:
			numNextFrame = 1;
		...
		case 11:
		{
			...
			if (typeSub == 14)
			{
				point6.fraImgEff = new FrameImage(typeSub, 55, 55);
			}
			else
			{
				point6.fraImgEff = new FrameImage(typeSub, 55, 55, 40, 40);
			}
		...
		case 26:
			...
			{
				fraImgEff = new FrameImage(466, 4);
			}
			else
			{
		...
		case 40:
			...
			{
				fraImgEff = new FrameImage(462, 4);
				fraImgSubEff = new FrameImage(329, 56, 31);
			}
			else
			{
		...
		case 171:
			...
			if (typeSub == 1)
			{
				fraImgEff = new FrameImage(448, 10);
				fRemove = 10;
				numNextFrame = 1;
			}
			break;
		...
		case 180:
		{
			fraImgEff = new FrameImage(446, 10);
			fraImgSubEff = new FrameImage(411, 3);
			numNextFrame = 2;
			fRemove = 20;
		...
		case 111:
		{
			...
			for (int k = 0; k < 3; k++)
			{
				...
				point3.frame = CRes.random(fraImgSubEff.nFrame);
		...
		case 139:
			...
			break;
		case 184:
			fraImgEff = new FrameImage(464, 6);
			numNextFrame = 4;
			fRemove = 24;
			break;
		case 140:
		...
		case 24903:
			frameSuper = typeSub;
			fraImgEff = new FrameImage(903, 80, 80, (sbyte)2, frameSuper);
			fRemove = 120;
			numNextFrame = 15;
			break;
		case 24904:
			fraImgEff = new FrameImage(904, 40, 27, 40, 27);
			fraImgSubEff = new FrameImage(905, 45, 45, 34, 34);
			fRemove = 5;
			break;
		case 24908:
			levelPaint = -1;
			...
			fraImgEff = new FrameImage(908, 25, 21, 3);
			fRemove = CRes.random(30, 50);
			break;
		case 24906:
			if (GameCanvas.isLowGraOrWP_PvP())
	...
	public override void paint(mGraphics g)
	{
		try
		{
			...
			case 24908:
				...
				break;
			case 24906:
				for (int numPoint = 0; numPoint < VecEff.size(); numPoint++)
				{
					Point p = (Point)VecEff.elementAt(numPoint);
					if (p.subType == 1)
					{
						fraImgSubEff.drawFrameNew(p.frame, p.x, p.y, 0, 3, g);
					}
					else
					{
						fraImgEff.drawFrameNew(p.frame, p.x, p.y, 0, 3, g);
					}
				}
				break;
			case 141:
			...
			case 6:
				if (typeSub == 3)
				{
					for (int j = 0; j < VecEff.size(); j++)
					{
						...
						fraImgSub2Eff.drawFrameNew(indexEff_1 * fraImgEff.maxNumFrame + point2.f % fraImgEff.maxNumFrame, point2.x / 100, point2.y / 100, 0, 3, g);
					}
				}
			...
			case 11:
			{
				for (int k = 0; k < VecEff.size(); k++)
				{
					...
					point3.fraImgEff.drawFrame(point3.f / numNextFrame % point3.fraImgEff.nFrame, point3.x, point3.y, 0, 3, g);
				}
				break;
			}
			case 47:
			{
				for (int num43 = 0; num43 < VecEff.size(); num43++)
				{
					...
					fraImgEff.drawFrame(point34.f / numNextFrame % fraImgEff.nFrame, point34.x, point34.y, 0, 3, g);
				}
				break;
			}
			case 13:
			...
			case 21:
			{
				...
				{
					Point point35 = (Point)VecEff.elementAt(num45);
			...
			case 22:
			{
				...
				{
					Point point19 = (Point)VecEff.elementAt(num15);
					fraImgSubEff.drawFrame(point19.f / numNextFrame % fraImgSubEff.nFrame, point19.x, point19.y, Dir, 3, g);
				}
				if (isUpdateNormal)
				{
					fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, x, y, Dir, 3, g);
			...
			case 23:
			{
				...
				for (int num61 = 0; num61 < VecEff.size(); num61++)
				{
					...
					fraImgSubEff.drawFrame(point48.f / numNextFrame % fraImgSubEff.nFrame, point48.x, point48.y, Dir, 3, g);
				}
				break;
			}
			case 26:
			...
			case 27:
				if (f <= fRemove)
				{
					...
					fraImgEff.drawFrame(num6, x, y, Dir, 3, g);
				}
				if (typeSub == 2)
				{
					for (int num7 = 0; num7 < VecEff.size(); num7++)
					{
						Point point11 = (Point)VecEff.elementAt(num7);
						fraImgSubEff.drawFrame(point11.f % fraImgSubEff.nFrame, point11.x, point11.y, Dir, 3, g);
					}
				}
				break;
			case 29:
			{
				...
				for (int num52 = 0; num52 < VecEff.size(); num52++)
				{
					...
					fraImgSub2Eff.drawFrame(point40.f % fraImgSub2Eff.nFrame, point40.x, point40.y, Dir, 3, g);
				}
				break;
			}
			case 30:
			{
				...
				{
					Line line = (Line)VecEff.elementAt(num49);
					if (line != null)
					{
						int color = 0;
						if (num49 / 2 < colorpaint.Length)
						{
							color = colorpaint[num49 / 2];
						}
						g.setColor(color);
			...
			case 25:
				...
				if (typeSub == 2)
				{
					...
					{
						Point point26 = (Point)VecEff.elementAt(num31);
						fraImgSub2Eff.drawFrame(point26.f % fraImgSub2Eff.nFrame, point26.x, point26.y, Dir, 3, g);
					}
				}
				break;
			case 35:
			...
			case 38:
			{
				...
				{
					Point point53 = (Point)VecEff.elementAt(num68);
					fraImgEff.drawFrame(point53.f % fraImgEff.nFrame, point53.x, point53.y, Dir, 3, g);
				}
				break;
			}
			case 138:
			{
				...
				{
					Point point46 = (Point)VecEff.elementAt(num59);
					fraImgEff.drawFrameNew(point46.frame * 4 + point46.f % fraImgEff.nFrame, point46.x, point46.y, Dir, 3, g);
				}
				break;
			}
			case 180:
			{
				...
				{
					Point point43 = (Point)VecEff.elementAt(num56);
					if (f > 15)
					{
						fraImgSubEff.drawFrameNew(f % fraImgSubEff.nFrame, point43.x, point43.y, Dir, 3, g);
					}
					fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, point43.x, point43.y, 0, 3, g);
				}
				break;
			}
			case 39:
			{
				...
				if (num50 > 2)
				{
					num50 = 2 + CRes.random(2);
				}
				fraImgEff.drawFrame(num50, x, y, Dir, 3, g);
				break;
			}
			case 40:
				if (f % 2 == 0)
			...
			case 185:
			{
				...
				if (num19 > 2)
				{
					num19 = 2 + CRes.random(2);
				}
				fraImgEff.drawFrame(num19, x, y, Dir, 3, g);
				break;
			}
			case 120:
			{
				...
				{
					Point point13 = (Point)VecEff.elementAt(num9);
					if (point13.frame < 2)
					{
						fraImgSubEff.drawFrameNew(point13.fSmall * fraImgSubEff.maxNumFrame + point13.f / 2 % fraImgSubEff.maxNumFrame, point13.x, point13.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrameNew(point13.fSmall * fraImgSub2Eff.maxNumFrame + point13.f / 2 % fraImgSub2Eff.maxNumFrame, point13.x, point13.y, 0, 3, g);
					}
				}
				break;
			}
			case 168:
			{
				...
				for (int l = 0; l < VecEff.size(); l++)
				{
					...
					if (point4.frame < 2)
					{
						fraImgSubEff.drawFrameNew(point4.fSmall * fraImgSubEff.maxNumFrame + point4.f / 2 % fraImgSubEff.maxNumFrame, point4.x, point4.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrameNew(point4.fSmall * fraImgSub2Eff.maxNumFrame + point4.f / 2 % fraImgSub2Eff.maxNumFrame, point4.x, point4.y, 0, 3, g);
					}
				}
				break;
			}
			case 183:
			{
				...
				{
					Point point55 = (Point)VecEff.elementAt(num70);
					fraImgEff.drawFrame(point55.f / numNextFrame % fraImgEff.nFrame, point55.x, point55.y, Dir, 3, g);
				}
				break;
			}
			case 169:
			...
			case 50:
			{
				...
				for (int num60 = 0; num60 < VecEff.size(); num60++)
				{
					...
					if (point47.frame < 2)
					{
						fraImgSubEff.drawFrame(point47.f / 2 % fraImgSubEff.nFrame, point47.x, point47.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrame(point47.f / 2 % fraImgSubEff.nFrame, point47.x, point47.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 54:
			{
				...
				{
					Point point37 = (Point)VecEff.elementAt(num47);
					...
					{
						fraImgEff.drawFrameNew((2 + num47 % 2) * fraImgEff.maxNumFrame + point37.f % fraImgEff.maxNumFrame, point37.x, point37.y, Dir, 3, g);
					}
					else if (typeSub == 9)
					{
						fraImgEff.drawFrameNew((frame + num47 % 2) * fraImgEff.maxNumFrame + point37.f % fraImgEff.maxNumFrame, point37.x, point37.y, Dir, 3, g);
					}
					else
					{
				...
				if (fraImgSubEff != null)
				{
					...
					{
						Point point38 = (Point)vecSubEff.elementAt(num48);
			...
			case 107:
			{
				...
				{
					Point point36 = (Point)VecEff.elementAt(num46);
					fraImgEff.drawFrame(point36.frame, point36.x, point36.y, 0, 3, g);
				}
				break;
			}
			case 110:
			{
				...
				{
					Point point32 = (Point)VecEff.elementAt(num41);
			...
			case 115:
			{
				...
				{
					Point point33 = (Point)VecEff.elementAt(num42);
			...
			case 60:
			{
				...
				{
					Point point25 = (Point)VecEff.elementAt(num30);
			...
			case 62:
			{
				...
				{
					Point point24 = (Point)VecEff.elementAt(num28);
					int num29 = point24.frame;
					if (f > fRemove - 4)
					{
						num29 += 3;
					}
					fraImgEff.drawFrame(num29, point24.x, point24.y, Dir, 3, g);
				}
				break;
			}
			case 66:
			{
				...
				fraImgEff.drawFrameNew(typeSub * 3 + num16, x, y, Dir, 3, g);
				break;
			}
			case 63:
				paintNo_Dat_New(g);
			...
			case 70:
			{
				for (int num14 = 0; num14 < VecEff.size(); num14++)
				{
					...
					fraImgEff.drawFrame(point18.frame, objTo.x, objTo.y + point18.y, Dir, 33, g);
				}
				break;
			}
			case 83:
			{
				...
				for (int num5 = 0; num5 < VecEff.size(); num5++)
				{
					...
					fraImgEff.drawFrame(point10.frame, objTo.x, objTo.y + point10.y, Dir, 33, g);
				}
				break;
			}
			case 73:
			...
			case 154:
			{
				...
				for (int m = 0; m < VecEff.size(); m++)
				{
					...
					Point point6 = null;
					point6 = ((m >= VecEff.size() - 1) ? ((Point)VecEff.elementAt(0)) : ((Point)VecEff.elementAt(m + 1)));
			...
			case 155:
			{
				...
				for (int n = 0; n < VecEff.size(); n++)
				{
					...
					fraImgEff.drawFrameNew(point7.f % 9 + f % fraImgEff.nFrame, point7.x, point7.y, 0, 3, g);
				}
				break;
			}
			case 75:
			case 78:
			{
				...
				int num66 = (int)(10.0 / (1.0 + (double)(GameCanvas.percent + GameCanvas.hardcodeSpeedUp) / 100.0));
				if (num66 <= 0)
				{
					num66 = 1;
				}
			...
			case 76:
			{
				...
				{
					Point point50 = (Point)VecEff.elementAt(num64);
					if (point50.frame == 0)
					{
						fraImgEff.drawFrame(point50.f % fraImgEff.nFrame, point50.x, point50.y, 0, 3, g);
					}
					else
					{
			...
			case 84:
			{
				...
				{
					Point point42 = (Point)VecEff.elementAt(num55);
					fraImgEff.drawFrame(point42.frame, point42.x, point42.y, point42.dis, 3, g);
				}
				break;
			}
			case 85:
			{
				...
				{
					Line line2 = (Line)VecEff.elementAt(num54);
					if (line2 == null)
					{
						continue;
					}
					...
					int color2 = 0;
					if (num54 / 2 < colorpaint.Length)
					{
						color2 = colorpaint[num54 / 2];
					}
					g.setColor(color2);
			...
			case 17:
			{
				...
				fraImgEff.drawFrame(num39, x, y, 0, 3, g);
				break;
			}
			case 31:
			{
				for (int num38 = 0; num38 < VecEff.size(); num38++)
				{
					...
					if (point31.dis == 1)
					{
						fraImgEff.drawFrameNew(point31.f / 2 % fraImgEff.nFrame, point31.x, point31.y, 0, 33, g);
					}
					else if (point31.dis == 0)
					{
						fraImgSubEff.drawFrameNew((point31.frame + point31.f / 2) % fraImgSubEff.nFrame, point31.x, point31.y, 0, 3, g);
					}
				}
				break;
			}
			case 32:
			{
				...
				{
					Point point29 = (Point)VecEff.elementAt(num36);
			...
			case 7:
			{
				...
				{
					Point_Focus point_Focus2 = (Point_Focus)VecEff.elementAt(num33);
			...
			case 93:
			{
				for (int num32 = 0; num32 < VecEff.size(); num32++)
				{
					...
					fraImgEff.drawFrame(point27.frame, point27.x, point27.y, 0, 3, g);
				}
				break;
			}
			case 46:
			...
			case 96:
			{
				...
				{
					Point_Focus point_Focus = (Point_Focus)VecEff.elementAt(num25);
			...
			case 98:
			{
				...
				for (int num13 = 0; num13 < VecEff.size(); num13++)
				{
					...
					fraImgSubEff.drawFrame(point17.f % 5, point17.x, point17.y, 0, 3, g);
				}
				break;
			}
			case 99:
			{
				...
				{
					Point point12 = (Point)VecEff.elementAt(num8);
					fraImgSub2Eff.drawFrame(point12.f % 5, point12.x, point12.y, 0, 3, g);
				}
				break;
			}
			case 172:
				...
				if (f > 5 && fraImgSubEff != null)
				{
					fraImgSubEff.drawFrame((f - 6) / 2 % fraImgSubEff.nFrame, x, y + objMainEff.hOne / 2, 0, 33, g);
				}
				break;
			case 173:
				fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, x, y, Dir, 3, g);
			...
			case 101:
			{
				for (int num3 = 0; num3 < VecEff.size(); num3++)
				{
					...
					if (objTo != null)
					{
						fraImgEff.drawFrame(point8.f, objTo.x + point8.x, objTo.y + point8.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 104:
			{
				...
				{
					Point point54 = (Point)VecEff.elementAt(num69);
					fraImgEff.drawFrame(point54.f, MainScreen.cameraMain.xCam + point54.x, point54.y, 0, 3, g);
				}
				break;
			}
			case 105:
			{
				...
				{
					Point point52 = (Point)VecEff.elementAt(num67);
					fraImgEff.drawFrame(point52.frame, MainScreen.cameraMain.xCam + point52.x, point52.y, 0, 3, g);
				}
				break;
			}
			case 106:
			...
			case 111:
			{
				...
				{
					fraImgEff.drawFrame(0, x, y - num62 * fraImgEff.frameHeight + 5, CRes.random(2) * 2, 33, g);
				}
				fraImgSub2Eff.drawFrame(f / 2 % fraImgSub2Eff.nFrame, x, y + 9, 0, 33, g);
				for (int num63 = 0; num63 < VecEff.size(); num63++)
				{
					Point point49 = (Point)VecEff.elementAt(num63);
					fraImgSubEff.drawFrameNew(point49.frame, x + point49.x, y + point49.y, Dir, 33, g);
				}
				break;
			}
			case 112:
				if (typeSub == 2)
				{
					fraImgEff.drawFrameNew(4 + frame, x, y, Dir, 36, g);
				}
				else
				{
			...
			case 113:
			{
				for (int num58 = VecEff.size() - 1; num58 >= 0; num58--)
				{
					Point point45 = (Point)VecEff.elementAt(num58);
			...
			case 116:
			{
				...
				{
					Point point44 = (Point)VecEff.elementAt(num57);
					fraImgEff.drawFrame(point44.f % fraImgEff.nFrame, point44.x, point44.y, 0, 3, g);
				}
				break;
			}
			case 117:
			...
			case 119:
			{
				for (int num53 = 0; num53 < VecEff.size(); num53++)
				{
					...
					if (point41.f < mPlayFrame.Length)
					{
						fraImgEff.drawFrameNew(mPlayFrame[point41.f], point41.x, point41.y, 0, 3, g);
					}
				}
				break;
			}
			case 182:
			{
				for (int num51 = 0; num51 < VecEff.size(); num51++)
				{
					...
					{
						fraImgEff.drawFrameNew(mPlayFrame[point39.f], point39.x, point39.y, Dir, 3, g);
					}
				}
				break;
			}
			...
			case 125:
			{
				...
				if (f < 3 || (f > 10 && f < 14))
				{
					num44 += CRes.random_Am_0(3);
				}
				fraImgEff.drawFrameNew(mPlayFrame[f], num44, y, 0, 33, g);
				break;
			}
			case 127:
			{
			...
			case 130:
				if (objTo != null)
				{
					...
					{
						Point point28 = (Point)VecEff.elementAt(num34);
			...
			case 136:
				...
				{
					for (int num27 = 0; num27 < mPlayFrameVip[f].Length; num27++)
					{
						fraImgEff.drawFrameNew(mPlayFrameVip[f][num27], x, y, 0, 3, g);
					}
				}
				break;
			case 137:
			{
				for (int num26 = 0; num26 < VecEff.size(); num26++)
				{
					...
					fraImgEff.drawFrame(point23.f / 4 % fraImgEff.nFrame, point23.x, point23.y, Dir, 33, g);
				}
				break;
			}
			case 139:
				...
				break;
			case 184:
				fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, x, y, 0, 33, g);
				break;
			case 140:
			case 167:
			{
				int num20 = CRes.random(2);
				for (int num21 = 0; num21 < VecEff.size(); num21++)
				{
					int num22 = num21 + num20;
					if (num22 >= VecEff.size())
					{
						num22 = 0;
					}
					Point point22 = (Point)VecEff.elementAt(num22);
					if (point22.frame == 1)
					{
						if (f > fRemove - 2)
						{
						...
						if (typeEffect == 140)
						{
							fraImgEff.drawFrameNew(frame, point22.x, point22.y, 0, 33, g);
						}
						continue;
					}
					if (f > fRemove - 2)
					...
					fraImgSubEff.drawFrameNew(frame, point22.x + num23, point22.y + num24, 0, 33, g);
				}
				break;
			}
			case 146:
			{
				...
				{
					Point point21 = (Point)VecEff.elementAt(num18);
					fraImgEff.drawFrame(3 + point21.f % 3, point21.x / 1000, point21.y / 1000, Dir, 3, g);
				}
				break;
			}
			case 147:
			...
			case 153:
			{
				...
				{
					Point point20 = (Point)VecEff.elementAt(num17);
					if (CRes.random(2) == 0)
					{
						fraImgSub2Eff.drawFrameNew(CRes.random(4) + point20.frame * 4, point20.x, point20.y, Dir, 3, g);
					}
				}
				break;
			}
			...
			case 160:
			{
				...
				{
					Point point14 = (Point)VecEff.elementAt(num10);
					if (!point14.isRemove)
					{
						fraImgEff.drawFrameNew(typeSub * fraImgEff.maxNumFrame + point14.frame, point14.x, point14.y, point14.dis, 3, g);
					}
				}
				break;
			}
			case 161:
			{
				...
				for (int num4 = 0; num4 < VecEff.size(); num4++)
				{
					...
					fraImgEff.drawFrameNew(typeSub * fraImgEff.maxNumFrame + point9.frame, point9.x / 100, point9.y / 100, 0, 3, g);
				}
				break;
			}
			case 162:
	...
	public override void update()
	{
		...
		case 182:
		{
			for (int num28 = 0; num28 < VecEff.size(); num28++)
			{
				Point point18 = (Point)VecEff.elementAt(num28);
				point18.update();
				if (point18.f >= point18.fRe)
				{
					VecEff.removeElementAt(num28);
					num28--;
				}
			}
		...
		case 185:
			...
			if (objTo != null)
			{
				if (typeSub != 3)
				{
					GameScreen.addEffectEnd_ObjTo(40, 4, objTo.x, objTo.y - objTo.hOne - 20, objTo.ID, objTo.typeObject, typeSub, objMainEff);
				}
				else
				{
					GameScreen.addEffectEnd_ObjTo(175, 0, objTo.x, objTo.y - objTo.hOne - 20, objTo.ID, objTo.typeObject, typeSub, objMainEff);
			...
			{
				GameScreen.addEffectEnd(40, 4, x, y, Dir, objMainEff);
			}
			else
			{
				GameScreen.addEffectEnd(175, 0, x, y, Dir, objMainEff);
		...
		case 47:
		{
			for (int num56 = 0; num56 < VecEff.size(); num56++)
			{
				Point point39 = (Point)VecEff.elementAt(num56);
				point39.update();
		...
		case 120:
		{
			for (int num45 = 0; num45 < VecEff.size(); num45++)
			{
				Point obj6 = (Point)VecEff.elementAt(num45);
				obj6.update();
				obj6.vy++;
			}
			if (f >= fRemove)
		...
		case 168:
		{
			...
			{
				Point obj4 = (Point)VecEff.elementAt(num39);
				obj4.update();
				obj4.vy++;
			}
			if (f >= fRemove)
		...
		case 183:
			if (typeSub > 0)
			{
				...
				{
					Point obj5 = (Point)VecEff.elementAt(num40);
					obj5.update();
					obj5.vy++;
				}
			}
		...
		case 107:
		{
			for (int num13 = 0; num13 < VecEff.size(); num13++)
			{
				((Point)VecEff.elementAt(num13)).update();
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 108:
		{
			...
			{
				Point point6 = (Point)VecEff.elementAt(num6);
				if (point6.f % 2 == 0)
				{
					point6.vy++;
				}
		...
		case 83:
		{
			...
			for (int num53 = 0; num53 < VecEff.size(); num53++)
			{
				Point point36 = (Point)VecEff.elementAt(num53);
				if ((point36.vy > 0 && point36.y >= 0) || (point36.vy < 0 && point36.y <= -30))
				{
					point36.vy = -point36.vy;
				}
				point36.y += point36.vy;
			}
			break;
		}
		case 70:
		{
			for (int num46 = 0; num46 < VecEff.size(); num46++)
			{
				...
				if ((point31.vy > 0 && point31.y >= 0) || (point31.vy < 0 && point31.y <= -30))
				{
					point31.vy = -point31.vy;
				}
				point31.y += point31.vy;
			}
			if (f == 30)
			{
				objTo.x = toX;
		...
		case 155:
		{
			for (int num33 = 0; num33 < VecEff.size(); num33++)
			{
				Point obj3 = (Point)VecEff.elementAt(num33);
		...
		case 78:
		{
			...
			if (typeSub != 1 && f < fRemove + 10)
			{
				...
				{
					Point point15 = new Point(x + CRes.random_Am_0(4), y + CRes.random_Am_0(4));
					point15.frame = CRes.random(3);
					point15.vy = -1 + CRes.random(3);
					point15.vx = CRes.random_Am_0(2);
					point15.fRe = 8 + CRes.random(4);
					VecEff.addElement(point15);
				}
			}
			for (int num24 = 0; num24 < VecEff.size(); num24++)
			{
				Point point16 = (Point)VecEff.elementAt(num24);
				point16.update();
				point16.vy++;
		...
		case 84:
		{
			for (int n = 0; n < VecEff.size(); n++)
			{
				...
				{
					if (point5.f - point5.fRe == 2)
					{
						point5.frame = 2;
					}
					if (point5.f - point5.fRe == 4)
					{
						point5.frame = 3;
					}
					if (point5.f - point5.fRe == 6)
					{
		...
		case 31:
		{
			...
			if (f < 10 && f % 3 == 2)
			{
				...
				{
					Point point28 = new Point(x + CRes.random_Am_0(20), y - CRes.random(30) + 10);
					point28.vy = -2 - CRes.random(4);
					point28.dis = 0;
					point28.frame = CRes.random(fraImgSubEff.nFrame);
					point28.fRe = CRes.random(12, 20);
					VecEff.addElement(point28);
				}
			}
			if (f >= fRemove && VecEff.size() == 0)
			{
		...
		case 32:
		{
			...
			if (f < fRemove && (f % 3 == 2 || f < 3))
			{
				...
				{
					Point point21 = new Point(x + CRes.random_Am_0(20), y + CRes.random(30) - 72);
					point21.vy = 2 + CRes.random(4);
					point21.dis = 0;
					point21.frame = CRes.random(fraImgSubEff.nFrame);
					point21.fRe = CRes.random(12, 20);
		...
		case 33:
			if (f % 5 == 0)
			{
				...
				sbyte b = 0;
				b = 2;
				LoginScreen.addEffectEnd(25, b, objMainEff.x + num27, objMainEff.y - objMainEff.dy - objMainEff.hOne / 3 * 2 + 10, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 15:
		{
			...
			if (f == 5)
			{
				...
				LoginScreen.addEffectEnd(16, 1, x + num10, objMainEff.y - objFireMain.hOne / 2 - 10 + num9, Dir, objMainEff);
			}
			if (f == 10)
			{
				int num11 = 30;
				...
				LoginScreen.addEffectEnd(16, 2, x + num11, objFireMain.y - objFireMain.hOne / 2 + num9, Dir, objMainEff);
			}
			if (f == 15)
			{
				int num12 = 20;
				...
				LoginScreen.addEffectEnd(16, 1, x + num12, objFireMain.y - objFireMain.hOne / 2 - 10 + num9, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 44:
			if (f % 4 == 0)
			{
				...
				LoginScreen.addEffectEnd(35, 0, objFireMain.x + num5, objFireMain.y - objFireMain.dy - objFireMain.hOne / 3 * 2 + 10, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 7:
		{
			...
			{
				Point_Focus point_Focus6 = (Point_Focus)VecEff.elementAt(num58);
				point_Focus6.update_Vx_Vy();
				if (point_Focus6.f >= point_Focus6.fRe)
				{
					VecEff.removeElement(point_Focus6);
					LoginScreen.addEffectEnd(1, 0, point_Focus6.toX, point_Focus6.toY, Dir, objMainEff);
					num58--;
				}
			}
			if (f == 10 || f == 13 || f == 16 || f == 19)
			{
				...
				int num59 = toX - x;
				int num60 = toY - y;
				int frameAngle = CRes.angle(num59, num60);
				Point_Focus p = new Point_Focus();
				p = create_Speed(num59, num60, p);
		...
		case 93:
		{
			for (int num55 = 0; num55 < VecEff.size(); num55++)
			{
				Point point38 = (Point)VecEff.elementAt(num55);
				point38.update();
				point38.vy++;
				if (point38.f >= point38.fRe)
				{
					VecEff.removeElement(point38);
					num55--;
				}
			}
		...
		case 95:
		{
			for (int num54 = 0; num54 < VecEff.size(); num54++)
			{
				Point point37 = (Point)VecEff.elementAt(num54);
				point37.update();
				if (point37.y < point37.y2 - 60)
				{
					point37.y = point37.y2;
				}
			}
			break;
		}
		case 96:
		{
			...
			{
				Point_Focus point_Focus4 = (Point_Focus)VecEff.elementAt(num48);
				point_Focus4.f++;
				if (point_Focus4.f < point_Focus4.fRe)
				{
					point_Focus4.x += point_Focus4.vx;
					point_Focus4.y += point_Focus4.vy;
					continue;
				}
				if (objTo != null)
				{
					point_Focus4.vx = 0;
					point_Focus4.vy = 0;
					point_Focus4.x = objTo.x;
					point_Focus4.y = objTo.y - objTo.hOne / 2;
				}
			...
			for (int num49 = 0; num49 < VecEff.size(); num49++)
			{
				Point_Focus point_Focus5 = (Point_Focus)VecEff.elementAt(num49);
				for (int num50 = 0; num50 < 3; num50++)
				{
					GameScreen.addEffectEnd(4, 0, point_Focus5.x - 20 + 20 * num50, point_Focus5.y - 20 + num50 % 2 * 20, Dir, objMainEff);
				}
			}
			VecEff.removeAllElements();
			removeEff();
		...
		case 99:
		{
			...
			for (int num41 = 0; num41 < VecEff.size(); num41++)
			{
				Point point25 = (Point)VecEff.elementAt(num41);
				point25.f++;
				if (point25.f >= 5)
				{
		...
		case 104:
		{
			if (f == 3 || f == 6)
			{
				int num36 = CRes.random(4, 7);
				for (int num37 = 0; num37 < num36; num37++)
				{
					Point point23 = new Point(x + CRes.random_Am_0(20), y + CRes.random_Am_0(10));
					point23.fRe = CRes.random(8, 11);
					point23.vy = -CRes.random(5, 7);
					VecEff.addElement(point23);
				}
			}
			for (int num38 = 0; num38 < VecEff.size(); num38++)
			{
				Point point24 = (Point)VecEff.elementAt(num38);
				point24.update();
		...
		case 111:
		{
			...
			for (int num17 = 0; num17 < VecEff.size(); num17++)
			{
				Point obj2 = (Point)VecEff.elementAt(num17);
				obj2.update();
				if (obj2.y < -210)
				{
			...
			if (f % 2 == 1)
			{
				...
				{
					Point point11 = new Point(CRes.random_Am_0(20), -5 + CRes.random(10));
					point11.vy = -CRes.random(12, 20);
		...
		case 113:
		{
			...
			if (f < 8)
			{
				...
				num = 360 / num2;
				int num4 = CRes.random(num);
				for (int j = 0; j < num2; j++)
				{
					Point point2 = new Point();
					point2.x = x * 1000 + CRes.getcos(CRes.fixangle(num4 + num * j) + f * 5) * f * vMax;
					point2.y = y * 1000 + CRes.getsin(CRes.fixangle(num4 + num * j) + f * 5) * f * (vMax - 4);
					point2.dis = f % 1;
					point2.fSmall = 1;
					if (typeSub == 2)
					{
			...
			for (int k = 0; k < VecEff.size(); k++)
			{
				...
				if (point3.f == 1)
				{
					if (point3.dis == 0)
					{
						int tile = GameCanvas.loadmap.getTile(point3.x / 1000, point3.y / 1000);
						if (tile == 0 || tile == 2)
						{
							GameScreen.addEffectEnd(66, (point3.frame != 1) ? 1 : 0, point3.x / 1000, point3.y / 1000, Dir, objMainEff);
						}
						else
						{
					...
					if (CRes.random(6) == 0)
					{
						GameScreen.addEffectEnd(110, (point3.frame != 1) ? 1 : 0, point3.x / 1000, point3.y / 1000, Dir, objMainEff);
					}
				}
				if (point3.f / 3 >= fraImgSubEff.maxNumFrame || point3.isRemove)
				{
		...
		case 116:
		{
			for (int num57 = 0; num57 < VecEff.size(); num57++)
			{
				Point point40 = (Point)VecEff.elementAt(num57);
				point40.update();
			...
			if (f % 5 == 1 && f < fRemove && CRes.random(2) == 0)
			{
				...
				point41.x = x + CRes.random_Am_0(10);
				point41.y = y + CRes.random(20);
				point41.vx = CRes.random_Am_0(3);
				point41.vy = -CRes.random(3, 7);
				point41.fRe = CRes.random(12, 18);
				VecEff.addElement(point41);
			}
			if (f % 4 == 1 && f < fRemove)
			{
				Point point42 = new Point();
				point42.x = x + CRes.random_Am_0(15);
				point42.y = y + CRes.random(20);
				point42.vx = CRes.random_Am_0(3);
				point42.vy = -CRes.random(3, 7);
				point42.fRe = CRes.random(4, 7);
				VecEff.addElement(point42);
			}
			if (f >= fRemove && VecEff.size() == 0)
			{
				removeEff();
		...
		case 119:
		{
			...
			if (f % 3 == 0 && f < fRemove)
			{
				...
				point33.fRe = mPlayFrame.Length;
				VecEff.addElement(point33);
			}
			if (f >= fRemove && VecEff.size() == 0)
			{
				removeEff();
		...
		case 180:
		{
			...
			{
				Point point30 = (Point)VecEff.elementAt(num44);
				point30.update();
		...
		case 126:
		{
			...
			if (step == 2 && VecEff.size() == 0)
			{
				...
				point_Focus2.fRe = 8;
				point_Focus2.x = x / 100;
				point_Focus2.y = y / 100;
				point_Focus2.vy = -4;
			...
			if (step == 1)
			{
				...
				if (frame == 8)
				{
					...
					create_Speed(xdich, ydich, point_Focus3, x1000, y1000, x / 100, y / 100);
		...
		case 130:
		{
			for (int num20 = 0; num20 < VecEff.size(); num20++)
			{
				...
				point13.x += point13.vx;
				point13.y += point13.vy;
				if (point13.y <= -60)
				{
					VecEff.removeElementAt(num20);
					num20--;
				}
			}
			if (f % 10 == 0)
			{
				for (int num21 = 0; num21 < 5; num21++)
				{
					...
					point14.x = CRes.random_Am_0(15);
					point14.y = 10 - CRes.random(40);
					point14.dis = 1 + CRes.random(3);
					point14.vy = -4;
					point14.frame = CRes.random(12);
		...
		case 137:
		{
			for (int num8 = 0; num8 < VecEff.size(); num8++)
			{
				Point point8 = (Point)VecEff.elementAt(num8);
				point8.x += vx;
				point8.f++;
				if (point8.f >= point8.fRe)
				{
					VecEff.removeElementAt(num8);
					num8--;
				}
			}
			if (f >= fRemove)
		...
		case 167:
		{
			for (int num7 = 0; num7 < VecEff.size(); num7++)
			{
				...
				if (CRes.random(3) == 0)
				{
					point7.x = x + CRes.random_Am_0(3);
					point7.y = y + CRes.random_Am_0(3);
				}
			}
			if (f >= fRemove)
			{
		...
		case 146:
		{
			for (int m = 0; m < VecEff.size(); m++)
			{
				((Point)VecEff.elementAt(m)).update();
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 153:
		{
			...
			for (int num51 = 0; num51 < VecEff.size(); num51++)
			{
				Point point34 = (Point)VecEff.elementAt(num51);
				point34.update();
				if (point34.x < MainScreen.cameraMain.xCam)
				{
					point34.x += MotherCanvas.w;
				}
				else if (point34.x > MainScreen.cameraMain.xCam + MotherCanvas.w)
				{
					point34.x -= MotherCanvas.w;
				}
				if (point34.f >= point34.fRe)
				{
					VecEff.removeElementAt(num51);
					num51--;
				}
			}
			if (f >= 140 && f <= 180)
			{
				for (int num52 = 0; num52 < MotherCanvas.w / 10 - 1; num52++)
				{
					if (CRes.random(4) == 0)
					{
						Point point35 = new Point(MainScreen.cameraMain.xCam + 5 + num52 * 10 + CRes.random(3), y);
						point35.vy = 5;
						point35.vx = CRes.random_Am_0(2);
						point35.fRe = MotherCanvas.h / 5 + CRes.random_Am_0(10);
						point35.frame = CRes.random(9);
						VecEff.addElement(point35);
					}
				}
			}
			x += vx;
		...
		case 158:
		{
			...
			{
				Point point19 = (Point)VecEff.elementAt(num29);
				point19.update();
				if (point19.x < MainScreen.cameraMain.xCam)
				{
					point19.x += MotherCanvas.w;
				}
				else if (point19.x > MainScreen.cameraMain.xCam + MotherCanvas.w)
				{
					point19.x -= MotherCanvas.w;
				}
				if (point19.f >= point19.fRe)
				{
					VecEff.removeElementAt(num29);
					num29--;
				}
			}
			if (f == 50)
			...
			{
				int num30 = MainScreen.cameraMain.xCam + 20 + (f - 40) / 2 * (MotherCanvas.w / 5);
				if (Dir == 2)
				{
					num30 = MainScreen.cameraMain.xCam + MotherCanvas.w - 20 - (f - 40) / 2 * (MotherCanvas.w / 5);
				}
				GameScreen.addEffectEnd(120, 0, num30, MainScreen.cameraMain.yCam + 50, Dir, objMainEff);
			}
			if (f >= 50 && f <= 54 && f % 2 == 0)
			{
				int num31 = MainScreen.cameraMain.xCam + 40 + (f - 50) / 2 * (MotherCanvas.w / 3);
				if (Dir == 2)
				{
					num31 = MainScreen.cameraMain.xCam + MotherCanvas.w - 20 - (f - 50) / 2 * (MotherCanvas.w / 3);
				}
				GameScreen.addEffectEnd(120, 0, num31, MainScreen.cameraMain.yCam + 30, Dir, objMainEff);
			}
			if (f >= 40 && f <= 90)
			{
				for (int num32 = 0; num32 < MotherCanvas.w / 10 - 1; num32++)
				{
					if (CRes.random(4) == 0)
					{
						Point point20 = new Point(MainScreen.cameraMain.xCam + 5 + num32 * 10 + CRes.random(3), MainScreen.cameraMain.yCam - 10);
						point20.vy = 5;
						point20.vx = CRes.random_Am_0(2);
						point20.fRe = MotherCanvas.h / 5 + CRes.random_Am_0(10);
						point20.frame = CRes.random(9);
						VecEff.addElement(point20);
					}
				}
			}
			x += vx;
		...
		case 160:
		{
			for (int num26 = 0; num26 < VecEff.size(); num26++)
			{
				Point point17 = (Point)VecEff.elementAt(num26);
				point17.x += point17.vx;
				point17.y += point17.vy;
				if (f < 6 || f > 12)
				{
					point17.vy = -1;
				}
				...
				if (f > 10)
				{
					if (num26 == 0 || num26 == VecEff.size() - 1)
					{
						point17.isRemove = true;
					}
					else
					{
						point17.frame = 2 + CRes.random(2);
					}
				}
				else if (f > 14 && num26 == 1)
				{
					point17.isRemove = true;
				}
			}
		...
		case 161:
		{
			for (int num14 = 0; num14 < VecEff.size(); num14++)
			{
				Point point9 = (Point)VecEff.elementAt(num14);
				point9.update();
			...
			if (f == 20 + lengthM - randomf)
			{
				...
				for (int num16 = 0; num16 < num15; num16++)
				{
					...
					point10.x = x * 100 + CRes.random_Am_0(200);
					point10.y = y * 100 + CRes.random_Am_0(200);
					point10.vx = CRes.random_Am_0(200);
					point10.vy = CRes.random_Am_0(200);
					point10.frame = 2 + CRes.random(2);
					point10.fRe = 6 + CRes.random(3);
	...
	private void createRock()
	{
		...
		else if (typeEffect == 110 || typeEffect == 24906)
		{
			if (typeEffect == 24906)
			{
				fraImgEff = new FrameImage(906, 10, 10, 4);
				fraImgSubEff = new FrameImage(907, 13, 11, 3);
			}
			else
			{
		...
		for (int i = 0; i < num; i++)
		{
			...
			point.fRe = fRemove;
			if (typeEffect == 110 || typeEffect == 24906)
			{
				point.frame = CRes.random(4);
				point.fRe = fRemove;
			}
	...
	private void create_Ussop_S3_L7()
	{
		if (typeSub == 0)
		{
			fraImgEff = new FrameImage(450, 9);
			fRemove = 18;
			numNextFrame = 2;
			return;
		}
		fraImgEff = new FrameImage(456, 10);
		fRemove = 30;
		numNextFrame = 3;
		for (int i = 0; i < 10; i++)
		{
			Point point = new Point(x + CRes.random_Am_0(200), y + CRes.random_Am_0(50));
			point.vx = CRes.random_Am_0(6);
			point.vy = -7 + CRes.random_Am_0(5);
			point.f = 0;
			VecEff.addElement(point);
	...
	private void createZoro_S3()
	{
		...
		{
			fraImgEff = new FrameImage(444, 9);
		}
		else
		{
		...
		else
		{
			...
			for (int k = 0; k < 5; k++)
			{
				Point point3 = new Point(x, y - 21 + k * 14);
				if (Dir == 2)
				{
					point3.x -= 6 * k;
				}
				...
				VecEff.addElement(point3);
				int num3 = point3.x;
				num3 = ((Dir != 2) ? (num3 - 10) : (num3 + 10));
				GameScreen.addEffectEnd_ToX_ToY(62, 0, num3, point3.y - 17, num3 + 12 * vx, point3.y - 17, Dir, objMainEff);
			}
		}
	}
	...
	{
		fraImgEff = new FrameImage(447, 6);
		numNextFrame = 2;
		fRemove = 12;
		Point point = new Point();
		point.x = x;
