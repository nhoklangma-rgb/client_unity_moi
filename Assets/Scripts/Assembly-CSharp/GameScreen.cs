...
public class GameScreen : MainScreen
{
	...
	{
		mVector mVector2 = new mVector();
		mVector2.addElement(new iCommand("T\u00e0n S\u00e1t: " + (mAuto.Instance.isTanSat ? T.on : T.off), 0, mAuto.Instance));
		mVector2.addElement(new iCommand("Gom Qu\u00e1i: " + (mAuto.Instance.isGomQuai ? T.on : T.off), 1, mAuto.Instance));
