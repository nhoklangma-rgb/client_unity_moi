...
public class ReadMessenge : AvMain
{
	...
	public const sbyte EFF_KIZURA = 30;
	...
	public void getData(Message msg)
	{
		...
		{
			mSystem.outloi("info hair e::" + ex.Message);
		}
	}
	...
	public void Effect_Obj(Message msg)
	{
		try
		{
			...
			case 6:
			{
				num3 = msg.reader().readShort();
				b3 = msg.reader().readByte();
				MainObject mainObject3 = MainObject.get_Object(num3, b3);
				if (mainObject3 != null)
				{
					GameScreen.addEffectEnd_ObjTo(101, 0, mainObject3.x, mainObject3.y, mainObject3.ID, mainObject3.typeObject, 0, mainObject);
				}
			...
			case 16:
			{
				...
				for (int i = 0; i < GameScreen.vecPlayers.size(); i++)
				{
					...
					if (mainObject2.typeObject == 0 && (mainObject2.clan == null || num4 != mainObject2.clan.ID))
					{
						mainObject2.addEffSpec(1, num2);
						GameScreen.addEffectEnd_Time(149, 0, mainObject2.x, mainObject2.y, mainObject2.ID, mainObject2.typeObject, 0, mainObject2, num2);
					}
				}
				break;
			}
			case 17:
			{
				...
				for (int k = 0; k < GameScreen.vecPlayers.size(); k++)
				{
					...
					if (mainObject5.typeObject == 0 && (mainObject5.clan == null || mainObject5.clan.ID != num4))
					{
						GameScreen.addEffectEnd_Time(151, 0, mainObject5.x, mainObject5.y, mainObject5.ID, mainObject5.typeObject, 0, mainObject5, num2);
						GameScreen.addEffectEnd_Time(150, 0, mainObject5.x, mainObject5.y, mainObject5.ID, mainObject5.typeObject, 0, mainObject5, num2 / 10);
					}
				}
				break;
			}
			case 18:
			{
				...
				for (int j = 0; j < GameScreen.vecPlayers.size(); j++)
				{
					...
					{
						GameScreen.addEffectEnd_Time(151, 1, mainObject4.x, mainObject4.y, mainObject4.ID, mainObject4.typeObject, 0, mainObject4, num2);
						mainObject4.addEffSpec(11, num2);
					}
				}
				break;
			}
			...
			case 26:
				if (mainObject != null)
				{
					short time4 = (short)(num2 * 100);
					GameScreen.addEffectBuffNew(mainObject, 2060, time4);
				}
				break;
			case 27:
			{
			...
			case 28:
				if (mainObject != null)
				{
					...
					{
						short id = msg.reader().readShort();
						int time3 = msg.reader().readInt();
						mainObject.addDataEff(id, time3);
					}
				}
				break;
			case 29:
			...
			case 30:
				...
				{
					int time2 = 5000;
					for (short num6 = 13; num6 < 17; num6++)
					{
						mainObject.addDataEff(num6, time2);
					}
				}
				break;
			case 31:
				...
				{
					int time = 5000;
					for (short num5 = 17; num5 < 19; num5++)
					{
						mainObject.addDataEff(num5, time);
					}
				}
				break;
			}
