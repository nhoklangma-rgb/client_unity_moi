...
public class Player : MainPlayer
{
	...
	public static short maxInventory = 250;

	public static short maxChest = 250;
	...
	public static MainObject objAutoFrist = null;
	...
	public mVector setSkillLan(Skill_Info skill)
	{
		...
		else
		{
			...
			for (int i = 0; i < GameScreen.vecPlayers.size(); i++)
			{
				...
				MainObject mainObject = (MainObject)GameScreen.vecPlayers.elementAt(i);
				if (mainObject.typeObject == b && mainObject != GameScreen.objFocus && setFightPk(mainObject) && MainObject.getDistance(GameScreen.objFocus.x, GameScreen.objFocus.y, mainObject.x, mainObject.y) <= (skill.indexSkillInServer == 825 || (skill.indexSkillInServer >= 812 && skill.indexSkillInServer <= 815) ? 250 : 120))
				{
